...
class TestReference(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ref4 = Reference('@/path/to/external.txt', None, None, None)
        self.ref5 = Reference('@/path/to/external.dat', None, None, None)
        self.ref6 = Reference()
        self.ref7 = Reference(None)
    ...
    def test_yaml(self):
        ...
        self.assertEqual(None, self.ref6.yaml)
